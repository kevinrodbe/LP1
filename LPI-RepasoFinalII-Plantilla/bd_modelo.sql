...
--
-- Host: localhost    Database: modelo
-- ------------------------------------------------------
...
CREATE TABLE `tb_producto` (
  ...
  `pre_pro` decimal(18,2) DEFAULT NULL,
  `cod_marca` int(11) NOT NULL,
  PRIMARY KEY (`cod_pro`),
  KEY `FK_producto_marca_idx` (`cod_marca`),
  CONSTRAINT `FK_producto_marca` FOREIGN KEY (`cod_marca`) REFERENCES `tb_marca` (`cod_marca`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2015-01-17 21:25:25
